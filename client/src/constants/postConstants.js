...
export const AI_SUGGESTIONS_REQUEST = "AI_SUGGESTIONS_REQUEST";
export const AI_SUGGESTIONS_SUCCESS = "AI_SUGGESTIONS_SUCCESS";
export const AI_SUGGESTIONS_RESET = "AI_SUGGESTIONS_RESET";
export const AI_SUGGESTIONS_FAIL = "AI_SUGGESTIONS_FAIL";
